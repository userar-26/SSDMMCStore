...
// Инициализирует KVS-хранилище, выделяя указанное количество байт памяти.
// storage_size_bytes — сколько байт выделить для хранилища.
// Возвращает 0 при успехе, отрицательное значение при ошибке.
int kvs_init(size_t storage_size_bytes);

// Деинициализирует KVS-хранилище и освобождает выделенную память.
